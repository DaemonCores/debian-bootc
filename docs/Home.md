...
debian-bootc delivers a complete, atomic, rollback-capable Debian operating system built as an OCI container image. It is the base layer for downstream projects like [Proxmox-Atomic](https://github.com/DaemonCores/Proxmox-Atomic). Every previous attempt to run bootc on Debian either stopped at a proof-of-concept stage or was quietly abandoned — this repository solves the problem end-to-end with automated CI builds, signed APT packages, and installer ISOs.
